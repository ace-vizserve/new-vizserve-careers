...
/**
 * Read-only candidate / application view. Shared by the HR application
 * detail page and the guest "shared candidate" page so both render the
 * exact same information.
 *
 *  - actionSlot — extra controls in the header (e.g. the Share button for HR)
 *  - notesSlot  — extra content under the details (e.g. the guest notes editor)
 */
